  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Required Fields */}
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          <h2 className="text-lg font-semibold mb-4">Required & Optional Fields</h2>
          <div className="mb-4">
            <h3 className="text-sm font-semibold text-gray-700 mb-2">Required Fields:</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">make *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">model *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">year *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">vin *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">price *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">mileage *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">exterior_color *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">transmission *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">fuel_type *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">body_style *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">city *</span>
              <span className="bg-red-50 text-red-700 px-2 py-1 rounded">province *</span>
            </div>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-700 mb-2">EDC-Specific Fields (Optional):</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
              <span className="bg-blue-50 text-blue-700 px-2 py-1 rounded">stock_number</span>
              <span className="bg-blue-50 text-blue-700 px-2 py-1 rounded">series</span>
              <span className="bg-blue-50 text-blue-700 px-2 py-1 rounded">equipment</span>
            </div>
          </div>
          <p className="mt-4 text-sm text-gray-500">
            Also optional: trim, interior_color, drivetrain, original_price, description, features (pipe-separated). 
            <br />
            <strong>EDC Column Mapping:</strong> Unit ID → stock_number, Kilometers → mileage, Ext Color → exterior_color, Equip → equipment
          </p>
        </div>
          ...
          {result && (
            <div className="mt-4 p-4 rounded-lg border border-gray-200 bg-gray-50">
              ...
              <div className="mt-4 text-sm text-gray-700">
                <p>
                  ✨ Generate AI photos for imported vehicles from the inventory page using the bulk AI generation feature.
                </p>
              </div>
