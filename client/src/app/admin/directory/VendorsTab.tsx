      ...
      <div className="overflow-hidden rounded-xl border border-slate-200/60">
        <table className="w-full table-auto text-sm">
          ...
          <tbody className="divide-y divide-slate-100">
            {loading ? (
              <tr><td className="px-4 py-4 text-slate-400 text-center" colSpan={8}>Loading...</td></tr>
            ) : paged.length === 0 ? (
              <tr><td className="px-4 py-4 text-slate-400 text-center" colSpan={8}>No vendors found.</td></tr>
            ) : (
              paged.map((r) => (
