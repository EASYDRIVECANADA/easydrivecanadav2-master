...
export default function DealershipDetailsSettingsPage() {
  ...
  const toggleButton = (
    <button
      ...
      className={
        useSequentialStockNumbers
          ? 'h-4 w-8 rounded-full bg-navy-900 relative'
          : 'h-4 w-8 rounded-full bg-white relative border border-slate-300'
      }
  ...
  return (
    <div className="space-y-6">
      ...
      {successModalOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true">
          ...
          <div className="edc-modal w-[420px] relative">
            ...
            <div className="p-4">
              <div className="text-sm text-slate-700">Successfully saved dealership info.</div>
      ...
      {updateModalOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true">
          ...
          <div className="edc-modal w-[420px] relative">
            ...
            <div className="p-4">
              <div className="text-sm text-slate-700">Successfully updated dealership info.</div>
              <div className="mt-4 flex justify-end">
                <button
                  type="button"
                  className="edc-btn-primary h-8 px-4 text-xs"
      ...
      <div>
        <div className="text-[11px] font-semibold text-slate-500">Company Logo</div>
        <div className="mt-3">
          <div className="h-12 w-28 border border-slate-200/60 bg-white relative overflow-hidden">
            {logoDataUrl ? (
      ...
      <div>
        <div className="text-[11px] font-semibold text-slate-500">Company Details</div>
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              className="h-8 w-full border border-slate-200/60 px-2 text-xs"
              value={companyName}
              onChange={(e) => setCompanyName(e.target.value)}
            />
          </div>
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">MVDA #</label>
            <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={mvda} onChange={(e) => setMvda(e.target.value)} />
          </div>
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Timezone</label>
            <select
              className="h-8 w-full border border-slate-200/60 px-2 text-xs bg-white"
              value={timezone}
          ...
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Website</label>
            <div className="relative">
              ...
              <input
                className="h-8 w-full border border-slate-200/60 pl-7 pr-2 text-xs"
                value={website}
      ...
      <div className="border border-slate-200/60">
        <div className="px-4 py-3">
          <div className="text-[11px] font-semibold text-slate-600">Primary Address</div>
          <div className="mt-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="lg:col-span-2">
              <label className="block text-[11px] text-slate-500 mb-1">Suite/Apt</label>
              <div className="relative">
                <div className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-400">
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                <input className="h-8 w-full border border-slate-200/60 pl-7 pr-2 text-xs" value={suiteApt} onChange={(e) => setSuiteApt(e.target.value)} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input className="h-8 w-full border border-slate-200/60 pl-7 pr-2 text-xs" value={city} onChange={(e) => setCity(e.target.value)} />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input className="h-8 w-full border border-slate-200/60 pl-7 pr-2 text-xs" value={postalCode} onChange={(e) => setPostalCode(e.target.value)} />
              </div>
            </div>
            <div>
            ...
            <div className="lg:col-span-2">
              ...
              <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={phone} onChange={(e) => setPhone(e.target.value)} />
            </div>
            <div className="lg:col-span-2">
              <label className="block text-[11px] text-slate-500 mb-1">Fax</label>
              <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={fax} onChange={(e) => setFax(e.target.value)} />
            </div>
            <div className="lg:col-span-2">
              <label className="block text-[11px] text-slate-500 mb-1">Email</label>
              <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={email} onChange={(e) => setEmail(e.target.value)} />
            </div>
            <div className="lg:col-span-2">
              <label className="block text-[11px] text-slate-500 mb-1">Mobile</label>
              <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={mobile} onChange={(e) => setMobile(e.target.value)} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="text-[11px] font-semibold text-slate-500">Tax/Registration Numbers</div>
        <div className="mt-2 border-t border-slate-200/60" />
        <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Tax #</label>
            <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={taxNumber} onChange={(e) => setTaxNumber(e.target.value)} />
          </div>
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">RIN</label>
            <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={rin} onChange={(e) => setRin(e.target.value)} />
          </div>
        </div>
      </div>

      <div>
        <div className="text-[11px] font-semibold text-slate-500">License Fees</div>
        <div className="mt-2 border-t border-slate-200/60" />
        <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">License Transfer Fee</label>
            <div className="relative">
              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-500 text-xs">$</div>
              <input
                className="h-8 w-full border border-slate-200/60 pl-6 pr-2 text-xs"
          ...
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">New Plate Fee</label>
            <div className="relative">
              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-500 text-xs">$</div>
              <input className="h-8 w-full border border-slate-200/60 pl-6 pr-2 text-xs" value={newPlateFee} onChange={(e) => setNewPlateFee(e.target.value)} />
            </div>
          </div>
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Renewal Fee</label>
            <div className="relative">
              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-500 text-xs">$</div>
              <input className="h-8 w-full border border-slate-200/60 pl-6 pr-2 text-xs" value={renewalFee} onChange={(e) => setRenewalFee(e.target.value)} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="mt-3">
          <div className="flex items-center gap-3">
            <div className="text-[11px] text-slate-500">Use sequential stock numbers?</div>
            {toggleButton}
          </div>
        </div>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Next Sales Invoice #</label>
            <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={nextSalesInvoice} onChange={(e) => setNextSalesInvoice(e.target.value)} />
          </div>
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Next Purchase Invoice #</label>
            <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={nextPurchaseInvoice} onChange={(e) => setNextPurchaseInvoice(e.target.value)} />
          </div>
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Next Work Order #</label>
            <input className="h-8 w-full border border-slate-200/60 px-2 text-xs" value={nextWorkOrder} onChange={(e) => setNextWorkOrder(e.target.value)} />
          </div>
        </div>

        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Service Rate</label>
            <div className="relative">
              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-500 text-xs">$</div>
              <input className="h-8 w-full border border-slate-200/60 pl-6 pr-2 text-xs" value={serviceRate} onChange={(e) => setServiceRate(e.target.value)} />
            </div>
          </div>
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Finance Interest Rate</label>
            <div className="relative">
              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-500 text-xs">%</div>
              <input
                className="h-8 w-full border border-slate-200/60 pl-6 pr-2 text-xs"
          ...
          <div>
            <label className="block text-[11px] text-slate-500 mb-1">Auto Close Deals In</label>
            <select
              className="h-8 w-full border border-slate-200/60 px-2 text-xs bg-white"
