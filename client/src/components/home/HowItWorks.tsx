export default function HowItWorks() {
  ...
  return (
    <section className="py-24 bg-secondary-50" aria-label="How to buy a car">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative" role="listitem">
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-8 left-[60%] w-full h-0.5 bg-gradient-to-r from-primary-300 to-primary-100" aria-hidden="true" />
              )}
