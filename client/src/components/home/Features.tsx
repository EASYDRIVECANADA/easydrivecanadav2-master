  ...
  const features = [
    {
      ...
      description: 'Every vehicle is inspected by certified mechanics covering engine, brakes, suspension, and more.'
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      description: 'Transparent, all-in pricing. The price you see is the price you pay — no surprises at signing.'
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      description: 'Get pre-approved in minutes. Competitive rates for all credit types, including first-time buyers.'
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      description: 'Your vehicle delivered right to your door anywhere in Ontario, at no extra cost.'
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      description: 'Comprehensive warranty coverage on every vehicle for your complete peace of mind.'
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      title: 'CARFAX Report',
      description: 'Full vehicle history included with every listing — accident records, service logs, and more.'
    },
  ]
