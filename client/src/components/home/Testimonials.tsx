...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'I was skeptical about buying a car online, but EasyDrive made it so easy. Highly recommend!',
...
export default function Testimonials() {
  return (
    <section className="py-24 bg-secondary-50" aria-label="Customer testimonials">
