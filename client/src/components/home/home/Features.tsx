export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: "Not happy? Return your vehicle within 10 days for a full refund. No questions asked."
    },
    {
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group p-6 rounded-2xl border border-secondary-100 hover:border-primary-200 hover:shadow-card transition-all duration-300"
            >
