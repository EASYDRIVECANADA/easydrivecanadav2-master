...
export default function Benefits() {
  const benefits = [
    ...
    },
    {
      ...
      description: '1-year complimentary coverage included'
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <Link 
              href="/guarantee"
              className="inline-flex items-center gap-2 mt-8 text-white font-semibold hover:underline"
            >
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl">
            <div className="text-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-secondary-900">Save Thousands</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center py-3 border-b border-secondary-100">
                ...
                <span className="font-semibold text-accent-green">Save $499</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-secondary-100">
              ...
              <div className="flex justify-between items-center pt-4">
                ...
                <span className="text-2xl font-bold text-primary-600">$2,797+</span>
              </div>
            </div>
          </div>
        </div>
